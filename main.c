...
char map[29][31] = {"hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh",
                    ...
                    "hhhhhhhbpbppppppppppppbpbhhhhhh",
...
int pck;
sfCircleShape *pacman[8];
sfRectangleShape *ghost1[GOST_P];
sfRectangleShape *ghost2[8];
sfRectangleShape *ghost3[8];
sfRectangleShape *ghost4[8];
...
void *Collision()
{
    ...
    i = (int)(pac.y / 20) - 2;
    j = (int)(pac.x / 20) - 1;
    if ((pac.x == g1.x && pac.y == g1.y) || (pac.x == g2.x && pac.y == g2.y) || (pac.x == g3.x && pac.y == g3.y) || (pac.x == g4.x && pac.y == g4.y))
    {
        lives -= 1;
        printf("Lives: %d\n", lives);
...
int main()
{
    ...
    sfCircleShape *pacman_dying[8];
    for (int i = 0; i < 8; i++)
    {
        pacman_dying[i] = sfCircleShape_create();
        sfCircleShape_setRadius(pacman_dying[i], 20.0f);
    }
    // Set image texture for pacman dying
    texture = sfTexture_createFromFile("img/pacman-dying1.png", NULL);
    sfCircleShape_setTexture(pacman_dying[0], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying2.png", NULL);
    sfCircleShape_setTexture(pacman_dying[1], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying3.png", NULL);
    sfCircleShape_setTexture(pacman_dying[2], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying4.png", NULL);
    sfCircleShape_setTexture(pacman_dying[3], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying5.png", NULL);
    sfCircleShape_setTexture(pacman_dying[4], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying6.png", NULL);
    sfCircleShape_setTexture(pacman_dying[5], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying7.png", NULL);
    sfCircleShape_setTexture(pacman_dying[6], texture, sfTrue);
    texture = sfTexture_createFromFile("img/pacman-dying8.png", NULL);
    sfCircleShape_setTexture(pacman_dying[7], texture, sfTrue);
    ...
    {
        // draw dying pacman
        sfCircleShape_setPosition(pacman_dying[i], (sfVector2f){pac.x, pac.y});
        sfRenderWindow_drawCircleShape(window, pacman_dying[i], NULL);
        sfRenderWindow_display(window);
        sleep(1);
    }
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        sfCircleShape_destroy(pacman_dying[i]);
